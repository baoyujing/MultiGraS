...
def test_rouge(cand, ref, num_processes):
    ...
    # process((candidates, references, 0))
    pool = Pool(n_pool)
...
if __name__ == "__main__":
    ref = ["water spinach is a green leafy vegetable grown in the tropics.", "the cat was under the bed"]
    cand = ["water spinach is a leaf vegetable commonly eaten in tropical areas of Asia.", "the cat was found under the bed"]
    results = test_rouge(cand=cand, ref=ref, num_processes=2)
    results = rouge_results_to_str(results)
    print(results)
